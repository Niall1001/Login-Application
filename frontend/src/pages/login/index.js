...
import { loginApi, sailingApi, TokenService } from '../../services';
...
import 'react-toastify/dist/ReactToastify.css';
    ...
    const loginClicked = async () => {
        ...
        try {
            const {
                data: { jwt },
            } = await loginApi.appUsers.login({ emailAddress: credentials.emailAddress, password: credentials.password });
