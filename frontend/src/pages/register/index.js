...
import { loginApi, sailingApi } from '../../services';
...
const Register = () => {
    ...
    const onSubmit = async (e) => {
        ...
        try {
            ...
            await loginApi.appUsers.regsiter({ name: credentials.name ,emailAddress: credentials.emailAddress, dob: credentials.dob, password: credentials.password, user_type: credentials.user_type });
	...
	return (
        ...
        <form class="form-signin">       
          ...
          <input class="form-control" type='name' id='name' placeholder="Name" onChange={onChange} disabled={credentials.isLoading} />
            ...
            <input class="form-control" type='usertype' id='user_type' placeholder="ADMIN/USER" onChange={onChange} disabled={credentials.isLoading} />
